...
Please add any words to [src/additional_words.txt](https://github.com/khulnasoft/codetypo-dicts/blob/main/dictionaries/en_GB/src/additional_words.txt) by making a pull request.
