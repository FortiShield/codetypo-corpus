...
```sh
npm install -g @codetypo/dict-en-ca
codetypo link add @codetypo/dict-en-ca
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-en-ca
```
...
{
    // …
    "import": ["@codetypo/dict-en-ca/codetypo-ext.json"],
    // …
}
```
